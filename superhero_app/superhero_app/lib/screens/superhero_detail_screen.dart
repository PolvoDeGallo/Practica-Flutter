              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        height: double.parse(superhero.powerStatsResponse.intelligence),
                        width: 20,
                        color: Colors.blue,
                      ),
                      Text("Intelligence")
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        height: double.parse(superhero.powerStatsResponse.strength),
                        width: 20,
                        color: Colors.grey,
                      ),
                      Text("Strength")
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        height: double.parse(superhero.powerStatsResponse.durability),
                        width: 20,
